          ...
          <div className="bg-white w-[70%] rounded p-3 shadow">
            ...
            <div className="flex items-end">
              <div className="ratings mt-2 flex items-center">
                ...
                <p className="text-reg text-black ml-3">4.9</p>
              </div>
              <div>
                <p className="text-reg text-black ml-4">600 Reviews</p>
              </div>
            </div>
            {/* RATING */} {/* DESCRIPTION */}
            <div className="mt-4">
            ...
            {/* DESCRIPTION */} {/* IMAGES */}
            <div>
              <h1 className="font-bold text-3xl text-black mt-10 mb-7 border-b pb-5">
                5 photos
              </h1>
                ...
                <div className="border-b pb-7 mb-7">
                  <div className="flex">
                    <div className="w-1/6 flex flex-col items-center">
                      ...
                      <p className="text-center text-black">Micheal Jordan</p>
                    </div>
